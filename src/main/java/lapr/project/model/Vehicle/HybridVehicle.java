...
public abstract class HybridVehicle extends AbstractNonCombustionVehicle {
     ...
     * @param energy
     */
    public HybridVehicle(String name, String description, String type, int vehicleClass, String motorization, String fuel, int mass, int load, double dragCoefficient, double frontalArea, double rollingReleaseCoefficient, double wheelSize, List<VelocityLimit> velocityLimitList, Energy energy) {
