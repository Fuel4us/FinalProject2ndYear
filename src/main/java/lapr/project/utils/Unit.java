...
public enum Unit {
    ...
    KILOGRAMS_PER_CUBIC_METER("kg/m^3"), NEWTON_METER("Nm"), KILOJOULE_PER_GRAM("KJ/g"), WATT("W"), GRAM_PER_KILOWATT_HOUR("g/kWh"),
    KILOJOULE("KJ"), EUROS("€"), HOUR("h"), NEWTON("N"), POSITION("º");
