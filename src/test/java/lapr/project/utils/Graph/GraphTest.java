...
public class GraphTest {
    ...
    public void testEndVertices() {
        ...
        assertTrue("first vertex should be A", instance.endVertices(edge1).get(0).equals("A"));
        assertTrue("second vertex should be B", instance.endVertices(edge1).get(1).equals("B"));
    }
